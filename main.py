    ...
    Env Manager Iz1m6g
    ==================
    Lightweight terminal utility built to search your filesystem and configurations.
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Lightweight terminal utility built to search your filesystem and configurations.")
